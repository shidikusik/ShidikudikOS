...
`/usr/share/shidikudik/store-catalog.ini` (29 apps: browsers, office,
...
- the chroot hook writes `/etc/shidikudik/autologin` containing `shidik`;
...
The graphical `shidik-install-gui` wizard ("Install ShidikudikOS" in the
